...
class AffineTransformer(Transformer):
    def apply_transform(
        ...
        if self.ndim == 2:
            ...
            print(f"translation shape in transf: {translation.shape}")
            print(f"rotation shape in transf: {rotation.shape}")
            print(f"scale shape in transf: {scale.shape}")
            print(f"shear shape in transf: {shear.shape}")
        ...
        print("rot mat shape in transf:", rot_mat.shape)
        ...
        print("Tmat shape in transf", Tmat.shape)
